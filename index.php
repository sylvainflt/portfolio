        ...
        <section class="contact" id="contact">
            ...
            <form action="sendEmail.php" method="post" id="formContact">
                <div id="nuages">
                    ...
                    <input type="text" class="form-control" id="nameContact" name="nameContact" placeholder="Nom" pattern="^[A-Za-z '-]+$" maxlength="20">
                    ...
                    <div class="form-floating" id="nuageEmail">
                        <input type="email" class="form-control" id="emailContact" name="emailContact" placeholder="Email" required pattern="^[A-Za-z]+@{1}[A-Za-z]+\.{1}[A-Za-z]{2,}$">
                        <label for="emailContact">Email : </label>
                    </div>                            
                            
                    <div class="form-floating" id="nuageMessage">
                        <!-- zone de texte étirable -->								
                        <textarea class="form-control" id="message" name="message" placeholder="Ecrivez votre message" 
                    ...
                    <div id="nuageBouton">                                            
                        <a onclick="submitContactForm()">Envoyer</a>               
                    </div>    
                </div>
            </form>
